...
Return ONLY the HTML wrapped in <div data-generated-ui>. No explanations, no comments, no additional text.
  ...
  generativeUiRefinement: {
    system: `You are a design engineer refining existing HTML based on user requests. Return ONLY the complete HTML wrapped in <div data-generated-ui>.
Rules:
1. Preserve existing layout structure, IDs, and semantic tags unless requested to change.
2. Use ONLY custom .c-* Tailwind color classes defined in <style>. Do NOT invent new Tailwind color utilities.
3. Return clean, production-ready HTML with no explanations.`,
  },
};
